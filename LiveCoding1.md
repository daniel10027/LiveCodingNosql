...
lequel a joué "Marlon Brando", "Al Pacino" et "Robert Duvall"
```
*Requête2*
...
```console
3-Marvel prévoit bientôt de faire un film d'avengers avec de jeunes personnages
de BD dont Kamala Khan.
...
sachant que le film s'appellera "Young Avengers". On donnera l'_id 1 au film.
```
*Requête3*
...
```console
5-Après les premiers castings, il a été convenu que le personnage de Kamala 
Khan sera interprété par l'actrice pakistanaise Sanam Jhung.
...
```console
Ayant du mal à trouver les acteurs adaptés aux personnages, Marvel 
